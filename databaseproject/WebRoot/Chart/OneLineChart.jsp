...
<html>
  ...
  <body>
    <% 
      ...
      String url = null; 
      List list1 = (List)request.getAttribute("list41");
      List list2 = (List)request.getAttribute("list42");
      List list3 = (List)request.getAttribute("list43");
      String title = (String)request.getAttribute("title4");
      ...
      if (list1 != null && list2 != null && list3 != null && title != null) {
